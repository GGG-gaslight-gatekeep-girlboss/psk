...
namespace CoffeeShop.DataAccess.Migrations
{
    ...
    [Migration("20250515165644_AddOrderPayment")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoffeeShop.BusinessLogic.OrderManagement.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CoffeeShop.BusinessLogic.PaymentManagement.Entities.CardPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CardPayment", (string)null);
                });

            modelBuilder.Entity("CoffeeShop.BusinessLogic.ProductManagement.Entities.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CoffeeShop.BusinessLogic.ProductManagement.Entities.ProductImage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CoffeeShop.BusinessLogic.OrderManagement.Entities.OrderItem", b =>
                {
                    ...
                    b.HasOne("CoffeeShop.BusinessLogic.OrderManagement.Entities.Order", "Order")
                        .WithMany("Items")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CoffeeShop.BusinessLogic.ProductManagement.Entities.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("CoffeeShop.BusinessLogic.ProductManagement.Entities.ProductImage", b =>
                {
                    ...
                    b.HasOne("CoffeeShop.BusinessLogic.ProductManagement.Entities.Product", "Product")
                        .WithOne("Image")
                        .HasForeignKey("CoffeeShop.BusinessLogic.ProductManagement.Entities.ProductImage", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
